...
$content = $this->email_contents->load_email_contents($_GET['id']);
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form id="email_contents_edit-form" method="POST" class="edit-form form-horizontal form-label-left" novalidate="novalidate">
							<input type="hidden" name="save_db" value="" />
							<input type="hidden" name="act" value="email_contents_edit" />
							<input type="hidden" name="id" value="<?php echo $content['ID'];?>" />
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="email_contents-label">Címke</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" class="form-control" id="email_contents-label" name="email_contents-label" value="<?php echo $content['Label'];?>" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" class="form-control" id="email_contents-hook" name="email_contents-hook" value="<?php echo $content['Hook'];?>" required>
								</div>
							</div>
							<?php endif;?>
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									...
									<div id="editor-one" class="editor-wrapper email_contents-content"><?php echo $content['Content'];?></div>
							...
							<div class="form-group form-float">
								<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
									<button id="email_contents_edit-form-submit" class="btn btn-primary" type="button">Felvisz</button>
