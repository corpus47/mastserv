<?php
$installation_cat = $this->installations->load_installation($_GET['id']);
?>
	...
	<div class="">
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						<h2>Installáció kategória szerkesztése: <?php echo $installation_cat['CategoryName'];?></h2>
						<div class="clearfix"></div>
					</div><!-- #x_title -->
					<div class="x_content">
						<form id="installation-form" class="edit-form form-horizontal form-label-left" method="POST" novalidate="novalidate">
							...
							<input type="hidden" name="act" value="installation_edit" />
							<input type="hidden" name="id" value="<?php echo $installation_cat['ID'];?>" />
							<div class="form-group form-float">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="installation-cat-name">Kategória</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" class="form-control" id="installation-cat-name" name="installation-cat-name" value="<?php echo $installation_cat['CategoryName'];?>" required>
                                </div>
                            </div>
                            <div class="form-group form-float">
							...
							<!--<div class="form-group form-float">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" class="form-control" id="installation-cost" name="installation-cost" value="<?php echo $installation_cat['Cost'];?>" required>
                                </div>
                            </div>-->
							<div class="form-group form-float">
								<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
