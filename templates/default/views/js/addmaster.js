...
$(document).ready(function(){
	...
	$('#master-form-submit').click(function(){
		...
		if($('input[name="master-cartype"]').val() == "") {
			$('input[name="master-cartype"]').after('<div class="error">A gépjármű típusa nem lehet üres!</div>');
			ret = false
		}
		
		if($('input[name="master-lpnumber"]').val() == "") {
			$('input[name="master-lpnumber"]').after('<div class="error">A gépjármű rendszáma nem lehet üres!</div>');
			ret = false
		}
